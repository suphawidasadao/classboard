            ...
            <div className="max-w-4xl mx-auto mt-8 p-6 bg-gray-100 rounded-xl shadow space-y-8">
                ...
                {units.map((unit, unitIdx) => (
                    <div key={unitIdx} className="bg-gray-200 p-4 rounded-xl space-y-6">
                                    ...
                                    {q.choices.map((choice, choiceIdx) => (
                                        <div key={choice.id} className={`${choice.color} p-4 rounded-xl`}>
                                            <textarea
                                                ...
                                                value={choice.text}
                                                onChange={(e) =>
                                                    updateChoiceText(unitIdx, qIdx, choiceIdx, e.target.value)
                                                }
                                            />
                                            <input
                                                type="checkbox"
                        ...
                        <button
                            onClick={() => addQuestionToUnit(unitIdx)}
                            className="mt-2 bg-white border border-gray-400 text-sm px-4 py-2 rounded-xl"
                        >
                ...
                <div className="flex justify-center mt-6">
                    <button
                        onClick={addNewUnit}
                        className="w-[12rem] h-12 bg-white border border-gray-300 text-gray-500 rounded-xl transition"
                    >
                        เพิ่มหน่วยถัดไป
                    </button>
                </div>
