    ...
    <div className="overflow-hidden h-screen">
      <div className="text-sm">
        ...
        <div className="bg-[#2e003e] flex items-start justify-center px-4 py-44 overflow-hidden">
          <div className="bg-white relative z-10 rounded-xl shadow-lg w-full max-w-[500px] p-10">
            <h2 className="text-xl font-semibold mb-6 text-center">เข้าสู่ระบบ ClassBoard</h2>
